<template>
    <Head title='Home' />
    <div class='flex flex-col px-60 pt-10 bg-gray-700 text-gray-50'>
        <div class='flex w-full min-h-40 justify-end bg-gray-500'>
        ...
        <div class='h-full mt-36 bg-indigo-700'>
