<template>
    <div class="flex items-center justify-center flex-col mr-10 bg-gray-300 rounded-lg" v-clickoutside="close">
        <div class="flex flex-row m-5">
            <BreezeInput @keyup.enter="this.$emit('newList', list_name)" id="list_name" type="text" class="block w-40" v-model="list_name" required autofocus autocomplete="list_name" />
